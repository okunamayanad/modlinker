(async () => {
    ...
    for (var i = 0; i < results.length; i++) {
        ...
        if (href.includes("curseforge") && href.includes("mc-mods")) {
            ...
            button.setAttribute("style", "width: auto;height: 20px;display: block; transform: translateY(-64px);");
            ...
            aContainer.setAttribute("style", "transition: all 0.5s cubic-bezier(0.16, 1, 0.3, 1); !important; display: flex;vertical-align: middle; height:0; justify-content: flex-end; transform: translateY(0px); opacity: 1; ");
